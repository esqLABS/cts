...
::: {layout-ncol="4"}
![Pavel B. \| Lead Scientist](img/Pavel.png){.portrait}

![Felix M. \| Project Lead, R Dev](img/Felix.png){.portrait}

![Laura K. \| Operations Manager](img/Laura.png){.portrait}

![Jérémy P. \| Senior Scientist](img/jeremy.png){.portrait}

![Diane L. \| Scientist, R Dev](img/Diane.png){.portrait}

![Robert M. \| C# Dev](img/Rob.png){.portrait}

![Rudolf E. \| R Dev](img/Rudolf.png){.portrait}
:::
...
![](../../img/CTS-architecture.png){fig-align="center"}
