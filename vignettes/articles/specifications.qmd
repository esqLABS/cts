...
This package is purely a programming interface and will not include a graphical
...
model library. These compound model snapshots are standardized json
files generated from PKSim and has this default structure:
...
-   a simulation project file (.pkml) that can be used to run the
    simulation in PKSim.
